  ...
  <div>
    <CRow>
      <CCol col="12">
          ...
          <CCardHeader>
            <CCol col="12" style="font-size: 25px;">{{ $t('message.create_new_cachout') }}</CCol>
          </CCardHeader>
          <CCardBody>
            <CRow>
              <CCol sm='12'>
            ...
            <CRow>
              ...
              <CCol sm="12">
                <CTextarea :label=" $t('message.description_ar')"
                  id="description_ar"
                  v-model="cachout.description_ar"
...
export default {
  ...
  methods: {
    createCashout:function (e)  {
     ...
     this.postRequest(formData, this.$hostUrl + 'cashouts', '/employees')
    }
  }
}
